...
data = dict(
    ...
    train=dict(
        type=dataset_type,
	ann_file=data_root_test + 'annotations/train.json',
    ...
    test=dict(
        type=dataset_type,
	ann_file=data_root_test + 'annotations/val_gt_for_mmdetction.json',
        img_prefix=data_root_test + '/leftImg8bit_trainvaltest/leftImg8bit/val_all_in_folder/',
        img_scale=(2048, 1024),
        img_norm_cfg=img_norm_cfg,
        size_divisor=32,
        flip_ratio=0,
...
log_level = 'INFO'
work_dir = './work_dirs/cityperson_ga_retinanet_x101_32x4d_fpn_1x'
load_from = None
resume_from = None
workflow = [('train', 1)]
