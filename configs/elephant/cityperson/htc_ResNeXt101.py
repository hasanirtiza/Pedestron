...
log_level = 'INFO'
work_dir = './work_dirs/htc_x101_64x4d_fpn_20e_pedestron_crowd_plus_wider_cp_finetune'
load_from = None
resume_from = './work_dirs/htc_x101_64x4d_fpn_20e_pedestron_crowd_plus_wider_cp_finetune/epoch_4.pth'
workflow = [('train', 1)]
