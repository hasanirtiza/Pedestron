...
wandb = dict(
    init_kwargs=dict(
        project="caltech",
        name="convmlp_hr_mixup_width_refine_ecp_2x16",
        entity="mlpthesis",
        config=dict(
            work_dirs="${work_dir}",
...
log_level = 'INFO'
work_dir = '/netscratch/hkhan/work_dirs/mlpod/caltech/convmlpHR_mixup_width_refine_ecp_2x16'
# load_from = None
load_from = '/netscratch/hkhan/work_dirs/mlpod/ecp/convmlpHRMixWidth4x4Refine/epoch_58.pth'
resume_from = None
