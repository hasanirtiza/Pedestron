...
wandb = dict(
    init_kwargs=dict(
        project="caltech",
        name="convmlp_hr_mixup_width_refine_tju_ecp_2x16",
        entity="mlpthesis",
        config=dict(
            work_dirs="${work_dir}",
...
log_level = 'INFO'
work_dir = '/netscratch/hkhan/work_dirs/mlpod/caltech/convmlpHR_mixup_width_refine_tju_ecp_2x16'
# load_from = None
load_from = '/netscratch/hkhan/work_dirs/mlpod/ecp/convmlpHRMixWidthTJU4x4NoCrowd/epoch_118.pth'
resume_from = None
