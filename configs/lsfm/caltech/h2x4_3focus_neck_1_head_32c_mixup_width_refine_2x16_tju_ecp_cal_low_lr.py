...
wandb = dict(
    init_kwargs=dict(
        project="caltech",
        entity="mlpthesis",
        name="nh_hr_2x32_mixup_width_refine_2x16_tju_ecp_low_lr",
        config=dict(
            work_dirs="${work_dir}",
...
log_level = 'INFO'
work_dir = '/netscratch/hkhan/work_dirs/mlpod/caltech/NH_HR2x32_mixup_width_refine_2x16_tju_ecp_low_lr/'
# load_from = None
