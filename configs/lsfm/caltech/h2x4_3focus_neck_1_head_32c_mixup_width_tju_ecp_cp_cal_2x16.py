...
wandb = dict(
    init_kwargs=dict(
        project="caltech",
        entity="mlpthesis",
        name="nh_hr_2x32_mixup_width_tju_ecp_98_cp_21_cal_2x16_redo",
        config=dict(
            work_dirs="${work_dir}",
...
log_level = 'INFO'
work_dir = '/netscratch/hkhan/work_dirs/mlpod/caltech/NH_HR2x32_mixup_width_tju_ecp_98_cp_21_2x16_redo/'
# load_from = None
load_from = '/netscratch/hkhan/work_dirs/mlpod/h2x4_3focus_neck_1_head_32c_mixup_width_tju_ecp_98_cp/epoch_21.pth'
resume_from = None
