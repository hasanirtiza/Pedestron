...
wandb = dict(
    init_kwargs=dict(
        project="MLPOD",
        entity="mlpthesis",
        name="h2x4_3focus_neck_1_head_32c_mixup_width_refine_ECPCoco_Cal_eval",
        config=dict(
            work_dirs="${work_dir}",
...
log_level = 'INFO'
work_dir = '/netscratch/hkhan/work_dirs/mlpod/h2x4_3focus_neck_1_head_32c_mixup_width_refine_ECPCoco/'
load_from = None
