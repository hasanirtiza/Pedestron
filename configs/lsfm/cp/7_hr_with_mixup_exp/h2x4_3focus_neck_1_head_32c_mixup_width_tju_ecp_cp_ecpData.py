...
wandb = dict(
    init_kwargs=dict(
        project="MLPOD",
        entity="mlpthesis",
        name="h2x4_3focus_neck_1_head_32c_mixup_tju_ecp_cp_ECPCoco",
        config=dict(
            work_dirs="${work_dir}",
...
log_level = 'INFO'
work_dir = '/netscratch/hkhan/work_dirs/mlpod/h2x4_3focus_neck_1_head_32c_mixup_width_tju_ecp_98_cp/'
# load_from = None
load_from = '/netscratch/hkhan/work_dirs/mlpod/ecp/NH_HR_mixup_width_tju_ecp/epoch_98.pth'
resume_from = None
