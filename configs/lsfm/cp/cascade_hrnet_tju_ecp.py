...
log_level = 'INFO'
work_dir = '/netscratch/hkhan/work_dirs/mlpod/cp/cascade_rcnn_tju_ecp'
load_from = "/netscratch/hkhan/work_dirs/mlpod/ecp/cascade_rcnn_tju/epoch_81.pth"
resume_from = None
workflow = [('train', 1)]
