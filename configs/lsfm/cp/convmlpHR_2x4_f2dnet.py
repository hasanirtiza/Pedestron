...
model = dict(
    type='CSP',
    pretrained="/netscratch/hkhan/wandb/train/20230127-124135-convmlp_hr_classification-224/checkpoint-79.pth.tar",
...
log_level = 'INFO'
work_dir = '/netscratch/hkhan/work_dirs/mlpod/convmlp_f2dnet/'
load_from = None
resume_from = None
# resume_from = '/netscratch/hkhan/work_dirs/mlpod/convmlp_f2dnet/epoch_79.pth'
workflow = [('train', 1)]
