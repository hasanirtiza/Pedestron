...
wandb = dict(
    init_kwargs=dict(
        project="MLPOD",
        entity="mlpthesis",
        name="convmlpHR_mixup_width_refine_tju_ecp",
        config=dict(
            work_dirs="${work_dir}",
...
log_level = 'INFO'
work_dir = '/netscratch/hkhan/work_dirs/mlpod/convmlp_hr_mixup_width_refine_tju_ecp/'
load_from = None
load_from = '/netscratch/hkhan/work_dirs/mlpod/ecp/convmlpHRMixWidth4x4RefineTJUNoCrowd/epoch_73.pth'
resume_from = None
