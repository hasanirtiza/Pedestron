...
wandb = dict(
    init_kwargs=dict(
        project="MLPOD",
        entity="mlpthesis",
        name="convmlpHR_mixup_width_tju_ecp_78",
        config=dict(
            work_dirs="${work_dir}",
...
log_level = 'INFO'
work_dir = '/netscratch/hkhan/work_dirs/mlpod/convmlp_hr_mixup_width_tju_ecp_78/'
# load_from = None
load_from = '/netscratch/hkhan/work_dirs/mlpod/ecp/convmlpHRMixWidthTJU4x4/epoch_78.pth'
resume_from = None
