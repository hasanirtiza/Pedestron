...
log_level = 'INFO'
work_dir = '/netscratch/hkhan/work_dirs/mlpod/ecp/cascade_rcnn_tju'
load_from = "/netscratch/hkhan/work_dirs/mlpod/tju/cascade_rcnn/epoch_21.pth"
resume_from = None
workflow = [('train', 1)]
