...
wandb = dict(
    init_kwargs=dict(
        project="ECP",
        entity="mlpthesis",
        name="conv_mlp_hr_mixup_width_4x4_refine_tju_no_crowd",
        config=dict(
            work_dirs="${work_dir}",
...
log_level = 'INFO'
work_dir = '/netscratch/hkhan/work_dirs/mlpod/ecp/convmlpHRMixWidth4x4RefineTJUNoCrowd'
load_from = None
load_from = '/netscratch/hkhan/work_dirs/mlpod/tju/convmlpHR2x4_mixup_width_ECPData_refine/epoch_66.pth'
resume_from = None
