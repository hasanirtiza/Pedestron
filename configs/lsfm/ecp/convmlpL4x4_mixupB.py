...
log_level = 'INFO'
work_dir = '/netscratch/hkhan/work_dirs/mlpod/ecp/convmlpLMix'
load_from = None
# load_from = '/netscratch/hkhan/work_dirs/csp_hrnet_ext/epoch_34.pth'
# resume_from = None
resume_from = '/netscratch/hkhan/work_dirs/mlpod/ecp/convmlpLMix/epoch_111.pth'
workflow = [('train', 1)]
