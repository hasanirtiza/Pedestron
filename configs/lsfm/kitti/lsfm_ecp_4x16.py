...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        ann_file='/netscratch/hkhan/kitti/train_ped.json',
    ...
    val=dict(
        type=dataset_type,
        ann_file='/netscratch/hkhan/kitti/val_ped.json',
        img_prefix=data_root,
        #img_scale=(1333, 800),
        img_scale=(1248, 384),
        img_norm_cfg=img_norm_cfg,
    ...
    test=dict(
        type=dataset_type,
        ann_file='/netscratch/hkhan/kitti/val_ped_easy.json',
        img_prefix=data_root,
        img_scale=(1248, 384),
        img_norm_cfg=img_norm_cfg,
        size_divisor=32,
...
evaluation = dict(interval=1, eval_hook='CocoDistEvalmAPHook', kitti=True)
# yapf:disable
log_config = dict(
    interval=50,
    hooks=[
...
log_level = 'INFO'
work_dir = '/netscratch/hkhan/work_dirs/mlpod/kitti/lsfm_4x16_ecp_mixup/'
# load_from = None
load_from = '/netscratch/hkhan/work_dirs/mlpod/ecp/NH_HR_mixup_width_refine/epoch_85.pth'
resume_from = None
