...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        ann_file=data_root + "discrete/images/train/front/det_3d_coco_ped.json",
        img_prefix="",
        mixup=True,
        zip_backend=True,
        img_scale=(1280, 800),
    ...
    val=dict(
        type=dataset_type,
        ann_file=data_root + "discrete/images/val/front/det_3d_coco_ped.json",
        img_prefix="",
        #img_scale=(1333, 800),
        img_scale = (1280, 800),
        img_norm_cfg=img_norm_cfg,
...
log_level = 'INFO'
work_dir = '/netscratch/hkhan/work_dirs/mlpod/shift/lsfm_mixup_width_refine/'
load_from = None
