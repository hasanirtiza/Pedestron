...
data = dict(
    ...
    val=dict(
        type=dataset_type,
        ann_file=data_root+'/annotations/ped_val_sorted.json',
...
log_level = 'INFO'
work_dir = '/netscratch/hkhan/work_dirs/mlpod/tju/cascade_rcnn'
load_from = None
resume_from = None
workflow = [('train', 1)]
