...
log_level = 'INFO'
work_dir = '/netscratch/hkhan/work_dirs/mlpod/caltech/cascade_rcnn_ecp_lr'
load_from = "/netscratch/hkhan/work_dirs/mlpod/ecp/cascade_rcnn/epoch_84.pth"
resume_from = None
workflow = [('train', 1)]
