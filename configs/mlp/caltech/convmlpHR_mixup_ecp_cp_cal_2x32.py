...
wandb = dict(
    init_kwargs=dict(
        project="caltech",
        name="convmlp_hr_mixup_ecp_cp_2x32",
        entity="mlpthesis",
        config=dict(
            work_dirs="${work_dir}",
...
log_level = 'INFO'
work_dir = '/netscratch/hkhan/work_dirs/mlpod/caltech/convmlpHR_mixup_ecp_cp'
#load_from = None
load_from = '/netscratch/hkhan/work_dirs/mlpod/convmlp_hr_mixup_ecp_cp/epoch_38.pth'
resume_from = None
