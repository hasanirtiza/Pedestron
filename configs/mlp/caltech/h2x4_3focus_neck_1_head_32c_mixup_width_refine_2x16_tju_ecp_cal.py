...
wandb = dict(
    init_kwargs=dict(
        project="caltech",
        entity="mlpthesis",
        name="nh_hr_2x32_mixup_width_refine_2x16_tju_ecp",
        config=dict(
            work_dirs="${work_dir}",
...
log_level = 'INFO'
work_dir = '/netscratch/hkhan/work_dirs/mlpod/caltech/NH_HR2x32_mixup_width_refine_2x16_tju_ecp/'
# load_from = None
load_from = '/netscratch/hkhan/work_dirs/mlpod/ecp/NH_HR_mixup_width_refine_tju_ecp_no_crowd/epoch_58.pth'
resume_from = None
