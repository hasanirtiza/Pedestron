...
wandb = dict(
    init_kwargs=dict(
        project="caltech",
        entity="mlpthesis",
        name="nh_hr_2x32_mixup_width_refine_2x32_tju_ecp_cp",
        config=dict(
            work_dirs="${work_dir}",
...
log_level = 'INFO'
work_dir = '/netscratch/hkhan/work_dirs/mlpod/caltech/NH_HR2x32_mixup_width_refine_2x32_tju_ecp_cp/'
# load_from = None
load_from = '/netscratch/hkhan/work_dirs/mlpod/h2x4_3focus_neck_1_head_32c_mixup_width_refine_tju_ecp/epoch_14.pth'
resume_from = None
