...
data = dict(
    ...
    test=dict(
        type=dataset_type,
        ann_file='./datasets/CityPersons/test_images.json',
        img_prefix=data_root + "leftImg8bit_trainvaltest/leftImg8bit/test/",
        # ann_file='./datasets/CityPersons/val_gt_mm_nested.json',
        # img_prefix=data_root + "leftImg8bit_trainvaltest/leftImg8bit/val/",
        img_scale=(2048, 1024),
        img_norm_cfg=img_norm_cfg,
...
wandb = dict(
    init_kwargs=dict(
        project="MLPOD",
        entity="mlpthesis",
        name="h2x4_3focus_neck_1_head_32c_mixup_width_refine_tju_ecp",
        config=dict(
            work_dirs="${work_dir}",
...
log_level = 'INFO'
work_dir = '/netscratch/hkhan/work_dirs/mlpod/h2x4_3focus_neck_1_head_32c_mixup_width_refine_tju_ecp/'
# load_from = None
load_from = '/netscratch/hkhan/work_dirs/mlpod/ecp/NH_HR_mixup_width_refine_tju_ecp/epoch_112.pth'
resume_from = None
