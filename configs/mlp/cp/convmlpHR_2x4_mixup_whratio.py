...
log_level = 'INFO'
work_dir = '/netscratch/hkhan/work_dirs/mlpod/convmlp_hr_mixup_whratio/'
load_from = None
# load_from = '/netscratch/hkhan/work_dirs/mlpod/ecp/convmlpHRMix/epoch_174.pth'
resume_from = None
# resume_from = '/netscratch/hkhan/work_dirs/mlpod/convmlp_hr_mixup_whratio/epoch_80.pth'
workflow = [('train', 1)]
