...
data_root = '/netscratch/hkhan/tju/dhd_campus_train_images/dhd_campus/'
INF = 1e8
img_norm_cfg = dict(
...
wandb = dict(
    init_kwargs=dict(
        project="TJU_PED",
        entity="mlpthesis",
        name="HR2x4_mixup_width_ECPData",
        config=dict(
            work_dirs="${work_dir}",
...
log_level = 'INFO'
work_dir = '/netscratch/hkhan/work_dirs/mlpod/tju/HR2x4_mixup_width_ECPData'
load_from = None
