...
wandb = dict(
    init_kwargs=dict(
        project="TJU_PED",
        entity="mlpthesis",
        name="convMLPHR4x4_mixup_ecp_cp_tju",
        config=dict(
            work_dirs="${work_dir}",
...
log_level = 'INFO'
work_dir = '/netscratch/hkhan/work_dirs/mlpod/tju/convmlpHR4x4_mixup_ecp_cp_tju_refine'
# load_from = None
load_from = '/netscratch/hkhan/work_dirs/mlpod/convmlp_hr_mixup_ecp_cp/epoch_7.pth'
resume_from = None
