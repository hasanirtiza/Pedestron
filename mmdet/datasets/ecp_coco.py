...
class ECPCocoDataset(CustomDataset):
...
def augment(img, gt_bboxes, gt_labels, gt_bboxes_ignore, size_train, small_box_to_ignore=False):
    ...
    if img.shape[0] >= size_train[0]:
        img, gt_bboxes, gt_labels, gt_bboxes_ignore = random_crop(img, gt_bboxes, gt_labels, gt_bboxes_ignore, size_train, limit=8, small_box_to_ignore=small_box_to_ignore)
    else:
        img, gt_bboxes, gt_labels, gt_bboxes_ignore = random_pave(img, gt_bboxes, gt_labels, gt_bboxes_ignore, size_train, limit=8, small_box_to_ignore=small_box_to_ignore)
